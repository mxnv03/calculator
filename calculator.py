...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_plav = QPushButton(",", self)
        self.hbox_third.addWidget(self.b_plav)
        ...
        self.hbox_third.addWidget(self.b_umn)
        ...
        self.b_plav.clicked.connect(lambda: self._button("."))
